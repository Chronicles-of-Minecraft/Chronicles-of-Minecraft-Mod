...
public class ModBlocks {
     ...
     * "flower_capparaceae_tropicalum_bottom"), flowerCapparaceaeTropicalumTop = new
     * CapparaceaeTropicalumTop().setRegistryName(ModCore.MOD_ID,
    ...
    public static final RegistryObject<Block> FLOWER_BULBUM_AER = BLOCKS.register("flower_bulbum_aer",
            () -> new BulbumAer());
    public static final RegistryObject<Block> FLOWER_COPRINUS_LUMUS = BLOCKS.register("flower_coprinus_lumus",
            () -> new CoprinusLumus());
    public static final RegistryObject<Block> FLOWER_COPRINUS_COMATUS = BLOCKS.register("flower_coprinus_comatus",
            () -> new CoprinusComatus());
    ...
    public static final RegistryObject<Block> FLOWER_BAMBUSA_GIVRA = BLOCKS.register("flower_bambusa_givra",
            () -> new BambusaGivra());

    /*
     * flowerArumTitanBottom = new ArumTitanBottom().setRegistryName(ModCore.MOD_ID,
     ...
     * ORES
     */
    public static final RegistryObject<Block> ORE_ALCHEMIUM = BLOCKS.register("ore_alchemium",
            () -> new Block(Block.Properties.create(Material.IRON)));
    public static final RegistryObject<Block> ORE_ALUMINIUM = BLOCKS.register("ore_aluminium",
            () -> new Block(Block.Properties.create(Material.IRON)));
    public static final RegistryObject<Block> ORE_ARSENIC = BLOCKS.register("ore_arsenic",
            () -> new Block(Block.Properties.create(Material.IRON)));
    public static final RegistryObject<Block> ORE_COBALT = BLOCKS.register("ore_cobalt",
            () -> new Block(Block.Properties.create(Material.IRON)));
    public static final RegistryObject<Block> ORE_COPPER = BLOCKS.register("ore_copper",
            () -> new Block(Block.Properties.create(Material.IRON)));
    public static final RegistryObject<Block> ORE_GALLIUM = BLOCKS.register("ore_gallium",
            () -> new Block(Block.Properties.create(Material.IRON)));
    public static final RegistryObject<Block> ORE_MYTHRIL = BLOCKS.register("ore_mythril",
            () -> new Block(Block.Properties.create(Material.IRON)));
    public static final RegistryObject<Block> ORE_SODIUM = BLOCKS.register("ore_sodium",
            () -> new Block(Block.Properties.create(Material.IRON)));
    ...
    public static final RegistryObject<Block> ORE_TIN = BLOCKS.register("ore_tin",
            () -> new Block(Block.Properties.create(Material.IRON)));
    public static final RegistryObject<Block> ORE_TITANIUM = BLOCKS.register("ore_titanium",
            () -> new Block(Block.Properties.create(Material.IRON)));
    public static final RegistryObject<Block> ORE_ZINC = BLOCKS.register("ore_zinc",
            () -> new Block(Block.Properties.create(Material.IRON)));
    public static final RegistryObject<Block> ORE_ZIRCONIUM = BLOCKS.register("ore_zirconium",
            () -> new Block(Block.Properties.create(Material.IRON)));
